import { prepareEmptyRules, restoreEmptyRules } from './batch-apply-empty-wrapper-v3-lowmem.js?v=20260828-lowmem1';
export async function runSelectiveFallback(){
  ...
  try{
    ...
    window.__emptyReplacementApply={version:3,mode:'lowmem-flex-first',prepared:prepared.total,complete:true,selective:true};
    return result;
