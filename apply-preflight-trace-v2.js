...
function install(){
  push('trace v2 loaded');installClickTrace();observePrepareIdentity();installPerfObserver();
  let ticks=0;const timer=setInterval(()=>{observePrepareIdentity();installPerfObserver();if(++ticks>1200)clearInterval(timer);},25);
}
