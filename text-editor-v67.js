// Text-only WinAnsi priority with corrected page-resource lookup. No cloud or graphics routing is changed.
import { editDoc as baseEditDoc } from './text-editor-v65.js?v=20260821-textonly-base2';
import { editSimpleWinAnsiDirect } from './text-winansi-direct-v2.js?v=20260821-resources1';
...
if(typeof window!=='undefined')window.__textEditorV67={version:'67+winansi-resources1'};
