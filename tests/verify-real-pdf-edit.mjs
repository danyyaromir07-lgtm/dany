...
console.log(`page_methods=${Object.getOwnPropertyNames(Object.getPrototypeOf(page)).join(',')}`);
console.log(`page_object_keys=${po.getKeys?.().join(',')||'none'}`);
console.log(`page_object_string=${String(po)}`);
console.log(`contents_get=${!!po.get?.('Contents')}`);
console.log(`contents_prop=${!!po.Contents}`);
console.log(`contents_getslash=${!!po.get?.('/Contents')}`);
console.log(`page_getContents=${typeof page.getContents}`);
