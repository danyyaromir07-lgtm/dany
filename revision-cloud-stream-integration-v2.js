...
import { removeDetectedRevisionCloudsByExactFamily } from './revision-cloud-stream-removal-v4.js?v=20260815-cloudstream-multi2';
...
async function applyExactFamilyCloudRemoval(){
  ...
  window.__revisionCloudStreamApplyDebug={removed,failures,version:4};
...
function install(){
  ...
  wrapped.__exactCloudStreamVersion=4;
...
window.__revisionCloudStreamIntegration={version:4};
