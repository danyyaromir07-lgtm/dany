...
async function applyExactFamilyCloudRemoval(){
  ...
  window.__revisionCloudStreamApplyDebug={removed,failures,version:'5+manual2+zero1'};
...
function install(){
  ...
  wrapped.__exactCloudStreamVersion='5+manual2+zero1';
...
window.__revisionCloudStreamIntegration={version:'5+manual2+zero1'};