...
async function applyExactFamilyCloudRemoval(){
  ...
  window.__revisionCloudStreamApplyDebug={removed,failures,version:'5+manual2+vectorzero2'};
...
function install(){
  ...
  wrapped.__exactCloudStreamVersion='5+manual2+vectorzero2';
...
window.__revisionCloudStreamIntegration={version:'5+manual2+vectorzero2'};