import { prepareEmptyRules, restoreEmptyRules } from './batch-apply-empty-wrapper-v2.js?v=20260828-emptytransaction1';
export async function runSelectiveFallback(){
  ...
  try{
    ...
    window.__emptyReplacementApply={version:2,mode:'transactional-reopen',prepared:prepared.total,complete:true,selective:true};
    return result;
