import './revision-cloud-vector-fallback-v2.js?v=20260820-sweepperf1';
...
async function applyExactFamilyCloudRemoval(){
  ...
  window.__revisionCloudStreamApplyDebug={removed,failures,version:'5+manual2+zeroexact1+singleexact1+coloroptional1+curvedgray2+directvector2'};
...
function install(){
  ...
  wrapped.__exactCloudStreamVersion='5+manual2+zeroexact1+singleexact1+coloroptional1+curvedgray2+directvector2';
...
window.__revisionCloudStreamIntegration={version:'5+manual2+zeroexact1+singleexact1+coloroptional1+curvedgray2+directvector2'};
