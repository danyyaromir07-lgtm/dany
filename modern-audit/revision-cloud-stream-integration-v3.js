...
async function applyExactFamilyCloudRemoval(){
  ...
  window.__revisionCloudStreamApplyDebug={removed,failures,version:'6+safeexact1'};
...
function install(){
  ...
  wrapped.__exactCloudStreamVersion='6+safeexact1';
...
window.__revisionCloudStreamIntegration={version:'6+safeexact1'};
