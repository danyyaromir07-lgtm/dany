// Empty-aware verification wrapper v3: structural/flexible editors first, text-only redaction fallback last.
import * as mupdf from 'https://cdn.jsdelivr.net/npm/mupdf@1.28.0/dist/mupdf.js';
import { editDoc as baseEditDoc } from './text-editor-empty-redact-v15.js?v=20260828-redactempty1';
...
if(typeof window!=='undefined')window.__textEditorV68EmptyAware={version:'68-empty-aware-v3-redact15'};
