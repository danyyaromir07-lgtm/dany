...
function rectsForRanges(chars,ranges){const out=[];for(const [a,b] of ranges)for(let i=a;i<=b;i++){const r=quadRect(chars[i]?.quad);if(r&&r[2]>r[0]&&r[3]>r[1])out.push(r)}return out}
...
if(typeof window!=='undefined')window.__textEditorEmptyGlyphRedactV16={version:'v16-structuredtext-flex-redact2'};
